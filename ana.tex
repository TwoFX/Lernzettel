...
\begin{document}
	...
	\sep
	\begin{multicols}{2}
	\begin{verfahren}[Liste von Stammfunktionen]
		Stünde dieser Satz nicht hier, wäre die Tabelle am falschen Platz.
		...
		\begin{tabular}{ | M{2.5cm} | M{2.5cm} | N}
			...
			$\frac{1}{x}$ & $\log\abs{x}$ & \\[0.6cm] \hline \hline
			...
			$\frac{1}{1+x^2}$ & $\arctan x$ & \\[0.6cm] \hline
		\end{tabular}
	\end{verfahren}
	\begin{verfahren}[Liste von Reihenwerten]
		\blindtext
	\end{verfahren}
	\end{multicols}
\end{document}
